...
!(function(e, t) {
            ...
            (e.prototype.onAudioFrame = function() {
                return i(this, void 0, void 0, function() {
                    ...
                    return s(this, function(i) {
                        switch (i.label) {
                            case 0:
                                // console.log("Valor de la frecuencia de los datos");
                                // console.log(this.freqData);
                                return (
                                    this.analyser.getFloatFrequencyData(this.freqData),
                                    this.freqData[0] === -1 / 0 ? [2] :
                                    (this.freqDataQueue.push(this.freqData.slice(0, this.columnTruncateLength)),
                                        ...
                                        ((e = p(this.freqDataQueue)),
                                            ...
                                            (n = void 0),
                                            this.includeRawAudio && ((a = p(this.timeDataQueue)), (n = f(a, [1, this.numFrames * this.fftSize]))), [4, this.spectrogramCallback(r, n)]) : [3, 2])
                                );
                            case 1:
                ...
                return i(this, void 0, void 0, function() {
                    return s(this, function(e) {
                        ...
                        return (
                            ...
                            null != this.stream && this.stream.getTracks().length > 0 && this.stream.getTracks()[0].stop(), [2]
                        );
                    });
                });
            }),
    ...
    var R = (function() {
            function e(r, n, a) {
                (this.MODEL_URL_PREFIX = "https://storage.googleapis.com/tfjs-models/tfjs/speech-commands/v" + D.split(".").slice(0, 2).join(".") + "/browser_fft"),
                            ...
                            switch (s.label) {
                                ...
                                case 5:
                                    ...
                                    return (
                                        ...
                                        (this.parameters.spectrogramDurationMillis = a * n), [2]
                                    );
                            }
                        });
                    });
                ...
                (e.prototype.ensureMetadataLoaded = function() {
                    return i(this, void 0, void 0, function() {
                        ...
                        return s(this, function(a) {
                            switch (a.label) {
                                case 0:
                                    return null != this.words ? [2] :
                                        "string" != typeof this.metadataOrURL ? [3, 2] : [
                                            4,
                                            (function(e) {
                                                return i(this, void 0, void 0, function() {
                                                    var t, n, a, i, o, l, u;
                    ...
                    return i(this, void 0, void 0, function() {
                        ...
                        return s(this, function(a) {
                            return (
                                ...
                                (console.log("Detected large dataset: total duration = " + this.dataset.durationMillis() + " ms > " + r + " ms. Training transfer model using fitDataset() instead of fit()"), [2, this.trainOnDataset(e)]) : [2, this.trainOnTensors(e)]
                            );
                        });
                    });
                }),
                            ...
                            switch (s.label) {
                                case 0:
                                    return (
                                        ...
                                        (i = a[0]),
                                        (o = a[1]),
                                        (u = t.util.now()), [4, this.model.fitDataset(i, { epochs: e.epochs, validationData: e.validationSplit > 0 ? o : null, callbacks: null == e.callback ? null : [e.callback] })]
                                    );
                                case 1:
                                    return (
                                        (c = s.sent()),
                                ...
                                case 1:
                                    return (
                                        ...
                                        ((c = (function(e, r, n) {
                                            ...
                                            (l = c.trainYs),
                                            (u = [c.valXs, c.valYs])) :
                                        ((o = a), (l = i)), [4, this.model.fit(o, l, { epochs: null == e.epochs ? 20 : e.epochs, validationData: u, batchSize: e.batchSize, callbacks: null == e.callback ? null : [e.callback] })]
                                    );
                                case 2:
                            ...
                            switch (s.label) {
                                case 0:
                                    return (
                                        ...
                                        this.model.compile({ loss: "categoricalCrossentropy", optimizer: a, metrics: ["acc"] }), [4, this.model.fitDataset(t, { epochs: e.fineTuningEpochs, validationData: r, callbacks: null == e.callback ? null : [e.callback] })]
                                    );
                                case 1:
                            ...
                            switch (s.label) {
                                case 0:
                                    return (
                                        ...
                                        this.model.compile({ loss: "categoricalCrossentropy", optimizer: i, metrics: ["acc"] }), [4, this.model.fit(t, r, { epochs: e.fineTuningEpochs, validationData: n, batchSize: e.batchSize, callbacks: null == e.fineTuningCallback ? null : [e.fineTuningCallback] })]
                                    );
                                case 1:
                                    ...
                                    t.tidy(function() {
                                        for (
                                            var a = [],
                                                ...
                                                h = u.shape[0],
                                                d = 0; d < e.wordProbThresholds.length;
                                            ++d
                                        ) {
                    ...
                    return i(this, void 0, void 0, function() {
                        ...
                        return s(this, function(a) {
                            return (
                                ...
                                console.log("Saving model to " + e), [2, this.model.save(e)]
                            );
                        });
                    });
                }),
